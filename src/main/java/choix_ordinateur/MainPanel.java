...
public class MainPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        intelRadio.setMnemonic('I');
        intelRadio.setDisplayedMnemonicIndex(0);
        ...
        amdRadio.setMnemonic('A');
        amdRadio.setDisplayedMnemonicIndex(0);
        ...
        lancerButton.setMnemonic('N');
        lancerButton.setDisplayedMnemonicIndex(2);
        ...
        label1.setLabelFor(ramComboBox);
        label2.setLabelFor(hddComboBox);
        label3.setLabelFor(screenComboBox);
        label4.setLabelFor(opticalComboBox);
        label5.setLabelFor(burnerComboBox);
