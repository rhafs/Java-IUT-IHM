...
public class MainPanel {
    ...
    public MainPanel(JFrame container) {
        ...
        minValueSlider.addChangeListener(e -> minValueField.setText(String.valueOf(minValueSlider.getValue())));
        maxValueSlider.addChangeListener(e -> maxValueField.setText(String.valueOf(maxValueSlider.getValue())));
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        minValueSlider.setOrientation(1);
        minValueSlider.setValue(0);
        panel1.add(minValueSlider, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        maxValueSlider = new JSlider();
        maxValueSlider.setOrientation(1);
        maxValueSlider.setValue(100);
        panel1.add(maxValueSlider, new GridConstraints(0, 6, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
